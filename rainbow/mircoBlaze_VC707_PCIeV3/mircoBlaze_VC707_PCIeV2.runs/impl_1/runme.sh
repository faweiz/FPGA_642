...
HD_PWD='D:/Tony/Downloads/RainbowGhost/Code/mircoBlaze_VC707_PCIeV3/mircoBlaze_VC707_PCIeV2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_preset_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mb_preset_wrapper.tcl -notrace
