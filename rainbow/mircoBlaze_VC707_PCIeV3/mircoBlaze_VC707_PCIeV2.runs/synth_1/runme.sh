...
HD_PWD='D:/Tony/Downloads/RainbowGhost/Code/mircoBlaze_VC707_PCIeV3/mircoBlaze_VC707_PCIeV2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_preset_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_preset_wrapper.tcl
