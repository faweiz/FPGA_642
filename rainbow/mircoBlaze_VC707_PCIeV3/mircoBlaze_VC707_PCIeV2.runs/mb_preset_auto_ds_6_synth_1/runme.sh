...
HD_PWD='D:/Tony/Downloads/RainbowGhost/Code/mircoBlaze_VC707_PCIeV2/mircoBlaze_VC707_PCIeV2.runs/mb_preset_auto_ds_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_preset_auto_ds_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_preset_auto_ds_6.tcl
